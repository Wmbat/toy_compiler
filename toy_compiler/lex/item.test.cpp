...
TEST_SUITE("Token test suite")
{
   TEST_CASE("to_string")
   {
      ...
      CHECK(to_string_view(item_type::add) == "add");
      CHECK(to_string_view(item_type::sub) == "sub");
      CHECK(to_string_view(item_type::mult) == "mult");
      CHECK(to_string_view(item_type::div) == "div");
      CHECK(to_string_view(item_type::equal) == "equal");
   ...
   TEST_CASE("fmt::formatter - token_type")
   {
      ...
      CHECK(fmt::format("{}", item_type::add) == "add");
      CHECK(fmt::format("{}", item_type::sub) == "sub");
      CHECK(fmt::format("{}", item_type::mult) == "mult");
      CHECK(fmt::format("{}", item_type::div) == "div");
      CHECK(fmt::format("{}", item_type::equal) == "equal");
